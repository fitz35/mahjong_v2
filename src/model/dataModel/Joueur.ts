...
export class Joueur {
    ...
    constructor(public readonly combinaisons: Array<Combinaison>, public readonly vent: NumeroVent, public readonly name: string, public readonly scores: Array<number>) {
