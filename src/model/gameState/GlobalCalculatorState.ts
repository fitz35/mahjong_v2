...
import { defaultGameSearchParamsCalculator, GameSearchParamsCalculator } from "./GameSearchParamsCalculator";
...
export class GlobalCulatorState {
    ...
    constructor(public readonly gameState : GameSearchParamsCalculator, error : UserException | undefined = undefined) {
        this.error = error;
    }
     ...
     */
    public static getDefault(error : UserException | undefined = undefined) : GlobalCulatorState {
     ...
     */
    public static copyWithoutError(calculatorState : GlobalCulatorState) : GlobalCulatorState {
