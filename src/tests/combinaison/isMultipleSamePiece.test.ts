...
describe("Test the isMultipleSamePiece algorithme", () => {
    it("Should be a pair", () => {
        ...
        expect(
            isMultipleSamePiece(toTest, NumeroVent.Est, NumeroVent.Est)
        ).toStrictEqual({
            base: BaseCombi.Paire,
    ...
    it("Should be a pair of dragon", () => {
        ...
        expect(
            ...
            base: BaseCombi.Paire,
            modificateur: new Set([ModificateurCombi.VentOuDragon]),
            famille: Famille.Dragon,
        });
    });
    ...
    it("Should be a carre of vent dominant", () => {
        ...
        expect(
            isMultipleSamePiece(toTest, NumeroVent.Ouest, NumeroVent.Est)
        ).toStrictEqual({
    ...
    it("should not be something, because the array is empty", () => {
        const toTest: Piece[] = [];
        expect(
            isMultipleSamePiece(toTest, NumeroVent.Est, NumeroVent.Est)
        ).toStrictEqual(undefined);
